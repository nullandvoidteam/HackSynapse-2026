...
/**
 * Shows a floating "+120 XP" gamified toast notification.
 */
...
/**
 * Shows a gamified achievement toast (Quest Complete, Badge Earned, etc.)
 */
  ...
  toast.custom(
    (t) => (
      <motion.div
        ...
        className={`flex items-center gap-3 ${cfg.bg} border ${cfg.border} text-white px-4 py-3 rounded-xl ${cfg.glow} backdrop-blur-sm select-none`}
      >
...
/**
 * GameToaster — Drop this once in the root layout or a page.
 * Renders all gamified toasts in the bottom-right corner.
 */
