...
/**
 * PixelTooltip — Speech-bubble style gamified tooltip.
 * Matches the "Ready for your next quest?" bubble style from the reference images.
 */
    ...
    >
      ...
      <AnimatePresence>
        {show && (
          ...
          >
            <div className="relative bg-[#1e1b4b]/95 border-2 border-[#6366f1] rounded-lg px-3 py-1.5 text-indigo-100 text-xs font-medium shadow-[0_0_16px_rgba(99,102,241,0.4)] whitespace-nowrap backdrop-blur-sm">
              {content}
