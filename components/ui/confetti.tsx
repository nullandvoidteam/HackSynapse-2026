 ...
 * e.g. fireConfetti("levelup") on completing a quest.
 */
...
/**
 * AutoConfetti — fires confetti automatically on mount. Useful for
 * celebration screens like onboarding completion.
 */
