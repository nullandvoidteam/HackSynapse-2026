...
export function CodeQuestOnboardingStep4({
  ...
  // Full-Body Dynamic Pixel Character Component
  const renderFullCharacter = () => {
    ...
    return (
      <svg
        viewBox="0 0 120 180"
        className="w-48 h-72 md:w-56 md:h-80 filter drop-shadow-2xl transition-all duration-300 select-none animate-float"
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#fbfbfa] text-slate-900 flex flex-col justify-between overflow-x-hidden font-sans selection:bg-emerald-500 selection:text-white">
      ...
      <header className="relative z-20 w-full max-w-7xl mx-auto px-6 pt-6 flex items-center justify-between">
        ...
        {/* Right Step Progress Bar (All 4 filled) */}
      ...
      {/* ========================================================
          CENTER CONTENT: QUESTION HEADER & 2-COLUMN STUDIO
         ======================================================== */}
      <main className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 flex-1 flex flex-col items-center">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-8">
          {/* ========================================================
              LEFT COLUMN: CUSTOMIZATION STUDIO CARD (~55% width)
             ======================================================== */}
          <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-8 border border-slate-100 shadow-xl space-y-6">
                ...
                {presets.map((preset, idx) => {
                  ...
                  return (
                    <div
                      ...
                      className={`relative bg-slate-50/80 rounded-xl p-2 border transition-all duration-200 cursor-pointer flex flex-col items-center justify-center select-none ${
                        isSelected
            ...
            {/* Section 2: Hair & Skin Tone (Two-Column Grid) */}
            ...
            {/* Section 3: Outfit & Color (Two-Column Grid) */}
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-5">
              {/* Outfits (4 Selectable Cards) */}
            ...
            {/* Section 4: Accessory (4-column grid) */}
            <div>
              <h3 className="font-bold text-xs uppercase tracking-wider text-slate-700 mb-2">
                ACCESSORY
              </h3>
          ...
          {/* ========================================================
              RIGHT COLUMN: LIVE RPG STAGE & HUD PREVIEW (~45% width)
             ======================================================== */}
          <div className="lg:col-span-5 relative w-full h-[580px] lg:h-[680px] rounded-3xl overflow-hidden shadow-xl border-4 border-slate-900/10 bg-slate-900 select-none">
            ...
            {/* Top Left Level HUD */}
            <div className="absolute top-5 left-5 z-20 bg-white/95 border border-slate-200 rounded-xl px-3 py-2 shadow-lg backdrop-blur-sm flex items-center gap-2">
              <div className="w-7 h-7 rounded-md bg-amber-100 flex items-center justify-center text-sm shrink-0">
                🧑‍💻
              </div>
            ...
            {/* Active Quest HUD */}
            <div className="absolute top-[72px] left-5 z-20 bg-[#fef9c3]/95 border border-[#facc15] rounded-xl px-3 py-2 shadow-lg backdrop-blur-sm max-w-[170px]">
            ...
            {/* Mascot Robot & Speech Bubble */}
            <div className="absolute top-5 right-5 z-20 flex flex-col items-end animate-float-slow">
              {/* Speech Bubble */}
              <div className="relative mb-2 bg-white/95 border-2 border-slate-300 rounded-xl px-3 py-2 shadow-md backdrop-blur-sm max-w-[190px] text-center">
            ...
            {/* Left Signpost */}
            <div className="hidden sm:flex absolute bottom-20 left-4 z-20 flex-col gap-1">
              <div className="bg-[#854d0e] border border-[#713f12] text-[#fef08a] font-pixel text-[7px] font-bold px-2 py-0.5 rounded-xs shadow-xs">
                CODE ▶
              </div>
              <div className="bg-[#854d0e] border border-[#713f12] text-[#fef08a] font-pixel text-[7px] font-bold px-2 py-0.5 rounded-xs shadow-xs">
                BUILD ▶
        ...
        <div className="w-full max-w-7xl flex items-center justify-between gap-4 mt-2">
          ...
          {/* Right Start My Adventure Button */}
          <button
            onClick={handleStartAdventure}
            className="bg-emerald-600 hover:bg-emerald-500 active:bg-emerald-700 text-white font-bold text-base tracking-wide px-8 py-3.5 rounded-xl shadow-[0_6px_20px_rgba(5,150,105,0.35)] hover:shadow-[0_8px_25px_rgba(5,150,105,0.45)] active:translate-y-0.5 active:shadow-md transition-all duration-200 flex items-center gap-2 cursor-pointer"
          >
