  ...
  return (
    <div className="relative min-h-screen w-full bg-[#f4f8f0] text-slate-900 flex flex-col justify-between overflow-x-hidden font-sans selection:bg-emerald-500 selection:text-white">
      ...
      <header className="relative z-20 w-full max-w-7xl mx-auto px-6 pt-6 flex items-center justify-between">
        ...
        {/* Right Step Progress Bar (All 4 Completed) */}
      ...
      <main className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 flex-1 flex flex-col items-center">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-8">
          {/* ========================================================
              LEFT PANEL: ADVENTURE CHARACTER & PORTAL SCENE (~45%)
             ======================================================== */}
          <div className="lg:col-span-5 relative w-full h-[580px] lg:h-[640px] rounded-3xl overflow-hidden shadow-xl border-4 border-slate-900/10 bg-slate-900 select-none group">
            ...
            {/* Companion Robot & Speech Bubble */}
            <div className="absolute top-6 right-6 z-20 flex flex-col items-end animate-float-slow">
              <div className="relative mb-2 bg-white/95 border-2 border-slate-300 rounded-xl px-3.5 py-2 shadow-md backdrop-blur-sm text-center">
            ...
            {/* Left Signpost Planks */}
            <div className="hidden sm:flex absolute bottom-24 left-4 z-20 flex-col gap-1 pointer-events-none">
              <div className="bg-[#854d0e] border border-[#713f12] text-[#fef08a] font-pixel text-[7.5px] font-bold px-2.5 py-0.5 rounded-xs shadow-xs">
                CODE ▶
              </div>
              <div className="bg-[#854d0e] border border-[#713f12] text-[#fef08a] font-pixel text-[7.5px] font-bold px-2.5 py-0.5 rounded-xs shadow-xs">
                BUILD ▶
            ...
            {/* Full-Body Adventurer in foreground */}
            <div className="absolute inset-0 flex items-center justify-center z-10 pt-16">
              <svg
                viewBox="0 0 120 180"
                className="w-48 h-72 md:w-56 md:h-80 filter drop-shadow-2xl select-none animate-float"
                style={{ imageRendering: "pixelated" }}
              >
                {/* Backpack */}
          ...
          {/* ========================================================
              RIGHT PANEL: QUEST SUMMARY & STATS DASHBOARD (~55%)
             ======================================================== */}
          <div className="lg:col-span-7 flex flex-col gap-6">
            {/* A. Active Quest Card (Primary Focus) */}
            <div className="bg-white rounded-3xl p-6 sm:p-7 border-2 border-emerald-400 shadow-xl relative">
              ...
              {/* Inner Split Card (Quest Task & Reward) */}
              <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 mt-5 bg-emerald-50/50 rounded-2xl p-4 border border-emerald-100 items-center">
                ...
                <div className="sm:col-span-7 flex items-center gap-3">
                  <div className="w-9 h-9 rounded-lg bg-indigo-900 border border-indigo-700 flex items-center justify-center text-emerald-400 font-mono font-bold text-xs shrink-0 shadow-xs">
                    &gt;_
                  </div>
                  <div>
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm grid grid-cols-3 divide-x divide-slate-100 items-center">
                {/* Level Stat */}
              ...
              <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="flex items-center justify-between gap-1 overflow-x-auto pb-2 select-none">
                  ...
                  <div className="flex flex-col items-center gap-1.5 shrink-0">
                    <div className="w-10 h-10 rounded-xl bg-blue-50 border border-blue-200 flex items-center justify-center text-lg shadow-2xs">
                      📘
                    </div>
                  ...
                  {/* Node 2 */}
                  <div className="flex flex-col items-center gap-1.5 shrink-0">
                    <div className="w-10 h-10 rounded-xl bg-indigo-50 border border-indigo-200 flex items-center justify-center text-lg shadow-2xs">
                      💻
                    </div>
                    <span className="text-[11px] font-bold text-slate-800">
                      Build
                  ...
                  {/* Node 3 */}
                  <div className="flex flex-col items-center gap-1.5 shrink-0">
                    <div className="w-10 h-10 rounded-xl bg-purple-50 border border-purple-200 flex items-center justify-center text-lg shadow-2xs">
                      🔮
                    </div>
                    <span className="text-[11px] font-bold text-slate-800">
                      AI
                  ...
                  {/* Node 5 */}
                  <div className="flex flex-col items-center gap-1.5 shrink-0">
                    <div className="w-10 h-10 rounded-xl bg-emerald-50 border border-emerald-200 flex items-center justify-center text-lg shadow-2xs">
                      🚩
                    </div>
                    <span className="text-[11px] font-bold text-slate-800">
                      Master
                ...
                {/* Bottom Grassy Terrain Accent Line */}
        ...
        <div className="w-full max-w-7xl flex flex-col sm:flex-row items-center justify-between gap-4 mt-2">
          ...
          <button
            onClick={handleBack}
            className="w-full sm:w-auto border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 font-bold px-6 py-3.5 rounded-xl transition-all shadow-sm active:translate-y-0.5 cursor-pointer text-sm flex items-center justify-center gap-2"
          >
            <span>←</span>
            <span>Back</span>
          </button>
          ...
          <div className="w-full sm:w-auto flex flex-col sm:flex-row items-center gap-3">
            <button
              ...
              className="w-full sm:w-auto border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 font-bold px-6 py-3.5 rounded-xl transition-all shadow-sm active:translate-y-0.5 cursor-pointer text-sm"
            >
              Review My Path
            </button>
            ...
            <button
              ...
              className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-500 active:bg-emerald-700 text-white font-extrabold text-base tracking-wide px-8 py-3.5 rounded-xl shadow-[0_6px_25px_rgba(5,150,105,0.4)] hover:shadow-[0_8px_30px_rgba(5,150,105,0.5)] active:translate-y-0.5 active:shadow-md transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer"
            >
      ...
      {/* ========================================================
          REVIEW MY PATH INTERACTIVE MODAL
         ======================================================== */}
      {showRoadmapModal && (
