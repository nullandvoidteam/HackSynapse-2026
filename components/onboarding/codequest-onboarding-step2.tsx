      ...
      characterIllustration: (
        <div className="w-20 h-20 relative flex items-center justify-center shrink-0">
          ...
          >
            ...
            {/* Face */}
            <rect x="22" y="16" width="20" height="14" rx="2" fill="#fde047" opacity="0.85" />
      ...
      characterIllustration: (
        <div className="w-20 h-20 relative flex items-center justify-center shrink-0">
          ...
          >
            ...
            {/* Backpack on Left */}
            <rect x="14" y="28" width="8" height="20" rx="3" fill="#854d0e" />
            {/* Open Glowing Spellbook/Codebook */}
      ...
      characterIllustration: (
        <div className="w-20 h-20 relative flex items-center justify-center shrink-0">
          ...
          >
            ...
            {/* Purple Jacket Open with Undershirt */}
    ...
    <div className="relative min-h-screen w-full bg-[#fbfbfa] text-slate-900 flex flex-col justify-between overflow-x-hidden font-sans selection:bg-emerald-500 selection:text-white">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <Image
          ...
          style={{ imageRendering: "pixelated" }}
        />
        {/* Soft Radial Gradient highlight */}
      ...
      <header className="relative z-20 w-full max-w-6xl mx-auto px-6 pt-6 flex items-center justify-between">
        ...
        {/* Right Step Progress Bar (Step 2 of 4) */}
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5 bg-white/90 border border-slate-200/80 px-3 py-1.5 rounded-full shadow-sm backdrop-blur-sm">
            {/* 4 Multi-Segment Step Progress Bars: Steps 1 & 2 filled */}
      ...
      {/* ========================================================
          CENTER CONTENT: QUESTION & 4-CARD 2X2 GRID
         ======================================================== */}
      <main className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 py-6 flex-1 flex flex-col items-center justify-center">
        ...
        {/* 4-Card Experience Selection Grid (2x2 Grid) */}
          ...
          {experienceTiers.map((tier) => {
            ...
            return (
              <div
                ...
                className={`relative bg-white rounded-2xl p-6 border transition-all duration-200 cursor-pointer flex items-center gap-5 select-none ${
                  isSelected
              ...
              >
                {/* Green Circular Checkmark Badge when Selected */}
                {isSelected && (
                  <div className="absolute top-4 right-4 w-6 h-6 bg-emerald-500 rounded-full text-white flex items-center justify-center shadow-sm text-xs font-black animate-scale-in">
                    ✓
                  </div>
                )}
                ...
                {/* Card Content & Starting XP Meter */}
